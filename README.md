# Terraform 1812 Configurations

This repository contains all the configuration resources required for the Terraform 1812 project to function properly and expose its business features.
